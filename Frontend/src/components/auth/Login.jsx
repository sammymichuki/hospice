      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-indigo-700 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center p-12">
          <div className="max-w-md">
            ...
            <h2 className="text-4xl font-bold mb-4 text-white drop-shadow-lg">Welcome to Medicore</h2>
            <p className="text-lg text-white drop-shadow-md">
              Your comprehensive healthcare management system. Access patient records, schedule appointments, and manage your practice efficiently.
            </p>
          </div>
        </div>
      </div>
